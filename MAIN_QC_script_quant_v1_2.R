################################################################################
#### R script for QC of quantitative proteomics data version 1.2 (May. 2022)

## !IMPORTANT!:
## Before using this script, make sure that your R and RStudio are updated to
## the newest version. We tested this script with R version 4.2.0 and RStudio
## version 2022.02.2 and cannot guarantee that this script will work with older
## versions.
...
source("QC_scripts/package_installation_v1_2.R")
...
PCA_Plot(X = D, groupvar1 = group, groupvar2 = NULL, groupvar1_name = groupvar_name, groupvar2_name = NULL,
         plot_device = plot_device, group_colours = group_colours,
...
# added Histograms
# shift code of graphics into seperate function
# allow normalization of data
# added advanced setting, like plot sizes, plot device and resolution, colours
# added functionality to install/update all necessary R packages

### Version 1.1 (2022-03-15):
# before plotting histograms --> remove all NAs (na.omit())
# 2nd boxplot-function with method = "violin"
# add code which checks if the output path/folder exists and if not create the new folder
# add advanced option to set x and y axis limits for PCA and Histograms
# several smaller changes in the different plotting scripts
